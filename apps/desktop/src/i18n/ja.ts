...
export const ja = defineLocale({
  ...
  settings: {
    ...
    quickEntry: {
      enabledTitle: 'クイック入力',
      enabledDesc:
        'グローバルショートカットで、メインウインドウを開かずにどこからでも小さな入力欄を呼び出せます。',
  ...
  artifacts: {
    ...
    loadOlder: '古いチャットを読み込む',
    loadingOlder: '古いチャットを読み込み中…',
    olderLoadFailed: '古いチャットを読み込めませんでした。',
    tabAll: 'すべて',
    groupArtifacts: '成果物',
    groupMedia: 'メディア',
    groupOther: 'その他',
    ...
    noCategoryTitle: category => `${category}はまだありません`,
    noSearchResults: '一致する成果物がありません',
  ...
  install: {
    ...
    connectExistingTitle: '既存の Jarvis 環境に接続',
    connectExistingShort: '既存環境に接続',
    connectExistingDesc:
      '別のコンピューターまたはホスト型サービスの Jarvis を使用します。この Mac には何もインストールされません。',
    installLocalTitle: 'はじめる',
    installLocalDesc: 'Jarvis が必要なものをこのコンピューターにダウンロードして準備します。',
    localStartUnavailable: 'セットアップを開始できません。JarvisAIGeorge を再起動して、もう一度お試しください。',
    remoteSetupTitle: '別の Jarvis 環境に接続',
    remoteSetupDesc:
      '別の Jarvis 環境から案内されたアドレスを入力してください。必要なサインイン方法を自動で確認します。',
    remoteUrlTitle: 'サービスアドレス',
    remoteUrlDesc: '完全なアドレスを入力してください。リモートサービスでは https:// を含めます。',
    remoteUrlPlaceholder: 'https://assistant.example.com',
    probing: 'サインイン要件を確認中...',
    probeError: 'そのアドレスに接続できませんでした。別の Jarvis 環境が実行中か確認してください。',
    identityProvider: 'ID プロバイダー',
    authTitle: '認証',
    authNeedsOauth: provider => `この接続をテストする前に ${provider} でサインインしてください。`,
    authSignedIn: 'ブラウザーサインインが完了しました。',
    connected: '接続済み',
    signIn: 'サインイン',
    signInWith: provider => `${provider} でサインイン`,
    enterUrlFirst: '先にサービスアドレスを入力してください。',
    signInIncomplete: '認証が完了する前にサインインウィンドウが閉じられました。',
    tokenTitle: 'セッショントークン',
    tokenDesc: '別の Jarvis 環境から提供されたセッショントークンを貼り付けます。',
    pasteSessionToken: 'セッショントークンを貼り付け',
    incompleteSignInTest: 'この接続をテストする前にサインインしてください。',
    incompleteTokenTest: 'この接続をテストする前にセッショントークンを入力してください。',
    testConnection: '接続をテスト',
    testSucceeded: (baseUrl, version) => `${baseUrl}${version ? ` (${version})` : ''} に接続しました。`,
    applyRemote: '接続',
    backToSetup: '戻る',
    failedTitle: 'インストールに失敗しました',
    settingUpTitle: 'Jarvis を設定中',
    finishingTitle: '仕上げ中',
    failedDesc:
