...
export const ar = defineLocale({
  ...
  boot: {
    ...
    failure: {
      title: 'يحتاج Jarvis إلى بعض الوقت',
      description: 'تعذر تشغيل خدمة مساعد Jarvis. جرب إحدى خطوات الاسترداد أدناه. لن يحذف ذلك محادثاتك أو إعداداتك.',
      remoteTitle: 'سجّل الدخول إلى Jarvis مرة أخرى',
      remoteDescription: 'انتهت صلاحية اتصال Jarvis المحفوظ. سجّل الدخول مرة أخرى لإعادة الاتصال.',
      retry: 'إعادة المحاولة',
      repairInstall: 'إصلاح Jarvis',
      useLocalGateway: 'استخدام هذا الـ Mac',
      cloudDownTitle: 'خدمة Nous Cloud متوقفة',
      cloudDownDescription:
        'تعيد خدمة Jarvis عبر الإنترنت خطأً من الخادم. لا يمكن إعادة تشغيلها من هنا — تحقق من حالتها، أو استخدم هذا الـ Mac، أو احصل على الدعم.',
      ...
      remoteSignInHint: signInLabel =>
        `يسجّل الخروج من جلسة المتصفح المحفوظة، ثم يفتح ${signInLabel}. اختر «استخدام هذا الـ Mac» للمتابعة مع Jarvis على هذا الكمبيوتر.`,
      ...
      signedInMessage: 'جار إعادة الاتصال بـ Jarvis...',
      ...
      signInToRemoteGateway: 'تسجيل الدخول إلى Jarvis',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة الإعدادات القياسية إلى افتراضيات Hermes؟ قد تبقى الإعدادات المخصصة.',
  ...
  artifacts: {
    ...
    loadingOlder: 'جار تحميل المحادثات الأقدم…',
    olderLoadFailed: 'تعذر تحميل المحادثات الأقدم.',
    tabAll: 'الكل',
    groupArtifacts: 'العناصر',
    groupMedia: 'الوسائط',
    groupOther: 'أخرى',
    tabDocuments: 'المستندات',
    tabWebFiles: 'ملفات الويب',
    tabImages: 'الصور',
    tabVideos: 'مقاطع الفيديو',
    tabAudio: 'الصوت',
    tabFiles: 'الملفات',
    tabLinks: 'الروابط',
    ...
    noCategoryTitle: category => `لا توجد ${category} بعد`,
