...
export const en: Translations = {
  jarvisIntro: {
    ...
    description: 'Ask a question, find something on your Mac, or hand me a task to take care of.',
    think: 'Plan my day',
    delegate: 'Take care of a task',
    return: 'Find something for me'
  },
  connectors: {
  ...
  settings: {
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut, without opening the main window.',
  ...
  cron: {
    ...
    emptyDescNew:
      'Ask Jarvis to handle something on a schedule and bring the result back here.',
    ...
    failedTrigger: 'Failed to run automation',
    ...
    createDesc: 'Tell Jarvis what to do and when. Natural phrases like “every weekday morning” work.',
    nameLabel: 'Name',
  ...
  artifacts: {
    ...
    olderLoadFailed: 'Older chats could not be loaded.',
    tabAll: 'All',
    groupArtifacts: 'Artifacts',
    groupMedia: 'Media',
    groupOther: 'Other',
    tabDocuments: 'Documents',
    tabWebFiles: 'Web files',
    tabImages: 'Images',
    tabVideos: 'Videos',
    tabAudio: 'Audio',
    tabFiles: 'Files',
    ...
    noCategoryTitle: category => `No ${category.toLowerCase()} yet`,
    noSearchResults: 'No matching artifacts',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Jarvis...',
  ...
  install: {
    ...
    setupChoiceTitle: 'Welcome to JarvisAIGeorge',
    setupChoiceDesc:
      'First, set up Jarvis on this computer. Then sign in with a supported provider, including your ChatGPT or Codex subscription. No API key is needed for that option.',
    connectExistingTitle: 'Connect an existing Jarvis setup',
    connectExistingShort: 'Connect existing setup',
    connectExistingDesc: 'Use Jarvis from another computer or hosted service. Nothing will be installed on this Mac.',
    installLocalTitle: 'Get started',
    installLocalDesc: 'Jarvis will download and prepare what it needs on this computer.',
    localStartUnavailable: 'Setup could not start. Restart JarvisAIGeorge and try again.',
    remoteSetupTitle: 'Connect another Jarvis setup',
    remoteSetupDesc: 'Enter the address provided by your other Jarvis setup. We’ll detect which sign-in method it uses.',
    remoteUrlTitle: 'Service address',
    remoteUrlDesc: 'Enter the full address, including https:// for a remote service.',
    remoteUrlPlaceholder: 'https://assistant.example.com',
    probing: 'Checking sign-in requirements...',
    probeError:
      "Jarvis can't reach that address. Check the address and make sure the other setup is running.",
    probeErrorDetails: 'Details',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    authNeedsOauth: provider => `Sign in with ${provider} before testing this connection.`,
    authSignedIn: 'Browser sign-in completed.',
    connected: 'Connected',
    signIn: 'Sign in',
    signInWith: provider => `Sign in with ${provider}`,
    enterUrlFirst: 'Enter a service address first.',
    signInIncomplete: 'The sign-in window closed before authentication completed.',
    remoteSignInError: 'Sign-in could not finish. Check your other setup and try again.',
    tokenTitle: 'Session token',
    tokenDesc: 'Paste the session token supplied by the other Jarvis setup.',
    pasteSessionToken: 'Paste session token',
    incompleteSignInTest: 'Sign in before testing this connection.',
    incompleteTokenTest: 'Enter a session token before testing this connection.',
    testConnection: 'Test connection',
    remoteTestError: 'Could not connect. Check the address and sign-in details, then try again.',
    testSucceeded: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` (${version})` : ''}.`,
    applyRemote: 'Connect',
    remoteApplyError: 'Could not save this connection. Please try again.',
    backToSetup: 'Back',
    failedTitle: 'Installation failed',
    settingUpTitle: 'Setting up Jarvis',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Jarvis is running, the internet connection dropped, or antivirus blocked the installer. Close other Jarvis windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
      'This is a one-time setup. Jarvis is downloading what it needs and configuring your machine. Subsequent launches will skip this step.',
  ...
  assistant: {
    thread: {
      ...
      errorProviderSetupTitle: 'Jarvis needs an AI provider',
      errorProviderSetup: 'Connect an AI provider in Settings, then try your message again.',
      errorOpenProviders: 'Open Providers',
      errorRetry: 'Retry',
