...
export const ru = defineLocale({
  ...
  boot: {
    ...
    failure: {
      title: 'Jarvis требуется немного времени',
      description:
        'Не удалось запустить службу помощника Jarvis. Попробуйте один из шагов восстановления ниже. Ничто из этого не удаляет ваши чаты и настройки.',
      remoteTitle: 'Войдите в Jarvis снова',
      remoteDescription:
        'Срок действия сохранённого подключения Jarvis истёк. Войдите снова, чтобы переподключиться. Ничто из этого не удаляет ваши чаты и настройки.',
      retry: 'Повторить',
      repairInstall: 'Восстановить Jarvis',
      useLocalGateway: 'Использовать этот Mac',
      gatewaySettings: 'Настройки подключения',
      back: 'Назад',
      ...
      remoteSignInHint: signInLabel =>
        `Выход из сохранённой сессии браузера, затем открытие ${signInLabel}. Выберите «Использовать этот Mac», чтобы продолжить работу с Jarvis на этом компьютере.`,
      signOutAndSignIn: 'Выйти и войти',
      remoteFailureHint: 'Проверьте адрес службы и вход в настройках подключения или используйте Jarvis на этом Mac.',
      hideRecentLogs: 'Скрыть недавние журналы',
      showRecentLogs: 'Показать недавние журналы',
      signedInTitle: 'Вы вошли в систему',
      signedInMessage: 'Переподключение к Jarvis…',
      ...
      signInToRemoteGateway: 'Войти в Jarvis',
  ...
  artifacts: {
    ...
    loadOlder: 'Загрузить старые чаты',
    loadingOlder: 'Загрузка старых чатов…',
    olderLoadFailed: 'Не удалось загрузить старые чаты.',
    tabAll: 'Все',
    groupArtifacts: 'Материалы',
    groupMedia: 'Медиа',
    groupOther: 'Другое',
    tabDocuments: 'Документы',
    tabWebFiles: 'Веб-файлы',
    ...
    noCategoryTitle: category => `Пока нет: ${category.toLowerCase()}`,
  ...
  install: {
    ...
    setupChoiceTitle: 'Добро пожаловать в JarvisAIGeorge',
    setupChoiceDesc:
      'Сначала настройте Jarvis на этом компьютере. Затем войдите через поддерживаемый сервис, включая подписку ChatGPT или Codex. Для этого API-ключ не нужен.',
    connectExistingTitle: 'Подключить существующую систему Jarvis',
    connectExistingShort: 'Подключить существующий',
    connectExistingDesc:
      'Используйте Jarvis на другом компьютере или в облачном сервисе. На этот Mac ничего не будет установлено.',
    installLocalTitle: 'Начать',
    installLocalDesc: 'Jarvis загрузит и подготовит всё необходимое на этом компьютере.',
    localStartUnavailable: 'Не удалось начать настройку. Перезапустите JarvisAIGeorge и попробуйте снова.',
    remoteSetupTitle: 'Подключить другую систему Jarvis',
    remoteSetupDesc: 'Введите адрес, указанный другой системой Jarvis. Мы определим способ входа.',
    remoteUrlTitle: 'Адрес сервиса',
    remoteUrlDesc: 'Введите полный адрес, включая https:// для удалённого сервиса.',
    remoteUrlPlaceholder: 'https://assistant.example.com',
    probing: 'Проверяем требования для входа...',
    probeError: 'Не удалось подключиться к этому адресу. Убедитесь, что другая система Jarvis запущена.',
    identityProvider: 'ваш провайдер аутентификации',
    authTitle: 'Аутентификация',
    authNeedsOauth: provider => `Сначала войдите через ${provider}, чтобы проверить это подключение.`,
    authSignedIn: 'Вход через браузер завершён.',
    connected: 'Подключено',
    signIn: 'Войти',
    signInWith: provider => `Войти через ${provider}`,
    enterUrlFirst: 'Сначала введите адрес сервиса.',
    signInIncomplete: 'Окно входа закрылось до завершения аутентификации.',
    tokenTitle: 'Сессионный токен',
    tokenDesc: 'Вставьте сессионный токен, предоставленный другой системой Jarvis.',
    pasteSessionToken: 'Вставьте сессионный токен',
    incompleteSignInTest: 'Войдите, чтобы проверить это подключение.',
    incompleteTokenTest: 'Введите сессионный токен, чтобы проверить это подключение.',
    testConnection: 'Проверить соединение',
    testSucceeded: (baseUrl, version) => `Подключено к ${baseUrl}${version ? ` (${version})` : ''}.`,
    applyRemote: 'Подключить',
    backToSetup: 'Назад',
    failedTitle: 'Установка не удалась',
    settingUpTitle: 'Настройка Jarvis',
