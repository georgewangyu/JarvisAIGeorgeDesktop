...
export const zh = defineLocale({
  ...
  boot: {
    ...
    failure: {
      title: 'Jarvis 需要一点时间',
      description: 'Jarvis 的助手服务未能启动。请尝试下面的恢复步骤；这里不会删除你的对话或设置。',
      remoteTitle: '请重新登录 Jarvis',
      remoteDescription: '你保存的 Jarvis 连接已过期。请重新登录以恢复连接。这些操作不会删除你的对话或设置。',
      retry: '重试',
      repairInstall: '修复 Jarvis',
      useLocalGateway: '使用这台 Mac',
      gatewaySettings: '连接设置',
      back: '返回',
      openLogs: '打开日志',
      repairHint: '修复会重新运行安装器，在新机器上可能需要几分钟。',
      remoteSignInHint: signInLabel =>
        `先退出已保存的浏览器会话，然后打开${signInLabel}。也可以选择“使用这台 Mac”，继续使用这台电脑上的 Jarvis。`,
      signOutAndSignIn: '退出并重新登录',
      remoteFailureHint: '在“连接设置”中检查服务地址和登录，或使用这台 Mac 上的 Jarvis。',
      cloudDownTitle: 'Nous Cloud 服务已停止',
      cloudDownDescription:
        '在线 Jarvis 服务正在返回服务器错误。无法在此处重启——请检查其状态、使用这台 Mac 或获取支持。',
  ...
  artifacts: {
    ...
    loadOlder: '加载更早的聊天',
    loadingOlder: '正在加载更早的聊天…',
    olderLoadFailed: '无法加载更早的聊天。',
    tabAll: '全部',
    groupArtifacts: '作品',
    groupMedia: '媒体',
    groupOther: '其他',
    ...
    noCategoryTitle: category => `暂无${category}`,
    noSearchResults: '没有匹配的内容',
  ...
  install: {
    ...
    connectExistingTitle: '连接现有 Jarvis 环境',
    connectExistingShort: '连接现有环境',
    connectExistingDesc: '使用另一台电脑或托管服务上的 Jarvis。这台 Mac 不会安装任何内容。',
    installLocalTitle: '开始使用',
    installLocalDesc: 'Jarvis 会在这台电脑上下载并准备所需内容。',
    localStartUnavailable: '无法开始设置。请重启 JarvisAIGeorge 后重试。',
    remoteSetupTitle: '连接另一套 Jarvis 环境',
    remoteSetupDesc: '输入另一套 Jarvis 环境提供的地址。我们会检测它使用的登录方式。',
    remoteUrlTitle: '服务地址',
    remoteUrlDesc: '输入完整地址；远程服务请包含 https://。',
    remoteUrlPlaceholder: 'https://assistant.example.com',
    probing: '正在检查登录要求...',
    probeError: '无法连接到该地址。请检查另一套 Jarvis 环境是否正在运行。',
    identityProvider: '你的身份提供方',
    authTitle: '认证',
    authNeedsOauth: provider => `测试此连接前请先使用 ${provider} 登录。`,
    authSignedIn: '浏览器登录已完成。',
    connected: '已连接',
    signIn: '登录',
    signInWith: provider => `使用 ${provider} 登录`,
    enterUrlFirst: '请先输入服务地址。',
    signInIncomplete: '认证完成前登录窗口已关闭。',
    tokenTitle: '会话令牌',
    tokenDesc: '粘贴另一套 Jarvis 环境提供的会话令牌。',
    pasteSessionToken: '粘贴会话令牌',
    incompleteSignInTest: '测试此连接前请先登录。',
    incompleteTokenTest: '测试此连接前请输入会话令牌。',
    testConnection: '测试连接',
    testSucceeded: (baseUrl, version) => `已连接到 ${baseUrl}${version ? ` (${version})` : ''}。`,
    applyRemote: '连接',
    backToSetup: '返回',
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 Jarvis',
    finishingTitle: '正在收尾',
    failedDesc:
  ...
  onboarding: {
    ...
    preparingInstall: '正在这台 Mac 上准备 Jarvis。通常不到一分钟。',
    starting: '正在准备 Jarvis…',
