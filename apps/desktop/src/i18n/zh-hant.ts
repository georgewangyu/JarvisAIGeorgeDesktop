...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    failure: {
      title: 'Jarvis 需要一點時間',
      description: 'Jarvis 的助理服務未能啟動。請嘗試下面的復原步驟。這裡的操作不會刪除您的聊天或設定。',
      remoteTitle: '請重新登入 Jarvis',
      remoteDescription: '您儲存的 Jarvis 連線已過期。請重新登入以重新連線。這裡的操作不會刪除您的聊天或設定。',
      retry: '重試',
      repairInstall: '修復 Jarvis',
      useLocalGateway: '使用這台 Mac',
      gatewaySettings: '連線設定',
      back: '返回',
      openLogs: '開啟記錄',
      repairHint: '修復會重新執行安裝程式，在新機器上可能需要幾分鐘。',
      remoteSignInHint: signInLabel =>
        `先登出已儲存的瀏覽器工作階段，然後開啟${signInLabel}。也可以選擇「使用這台 Mac」，繼續使用這台電腦上的 Jarvis。`,
      signOutAndSignIn: '登出並重新登入',
      remoteFailureHint: '在「連線設定」中檢查服務位址與登入，或使用這台 Mac 上的 Jarvis。',
      cloudDownTitle: 'Nous Cloud 服務已停機',
      cloudDownDescription:
        '線上 Jarvis 服務正在回傳伺服器錯誤。無法在此處重新啟動——請檢查其狀態、使用這台 Mac，或取得支援。',
  ...
  artifacts: {
    ...
    loadOlder: '載入較早的聊天',
    loadingOlder: '正在載入較早的聊天…',
    olderLoadFailed: '無法載入較早的聊天。',
    tabAll: '全部',
    groupArtifacts: '作品',
    groupMedia: '媒體',
    groupOther: '其他',
    ...
    noCategoryTitle: category => `尚無${category}`,
    noSearchResults: '沒有相符的內容',
  ...
  install: {
    ...
    connectExistingTitle: '連線現有 Jarvis 環境',
    connectExistingShort: '連線現有環境',
    connectExistingDesc: '使用另一台電腦或託管服務上的 Jarvis。這台 Mac 不會安裝任何內容。',
    installLocalTitle: '開始使用',
    installLocalDesc: 'Jarvis 會在這台電腦上下載並準備所需內容。',
    localStartUnavailable: '無法開始設定。請重新啟動 JarvisAIGeorge 後再試一次。',
    remoteSetupTitle: '連線另一套 Jarvis 環境',
    remoteSetupDesc: '輸入另一套 Jarvis 環境提供的位址。我們會偵測其使用的登入方式。',
    remoteUrlTitle: '服務位址',
    remoteUrlDesc: '輸入完整位址；遠端服務請包含 https://。',
    remoteUrlPlaceholder: 'https://assistant.example.com',
    probing: '正在檢查登入要求...',
    probeError: '無法連線到該位址。請確認另一套 Jarvis 環境正在執行。',
    identityProvider: '您的身分提供者',
    authTitle: '驗證',
    authNeedsOauth: provider => `測試此連線前請先使用 ${provider} 登入。`,
    authSignedIn: '瀏覽器登入已完成。',
    connected: '已連線',
    signIn: '登入',
    signInWith: provider => `使用 ${provider} 登入`,
    enterUrlFirst: '請先輸入服務位址。',
    signInIncomplete: '驗證完成前登入視窗已關閉。',
    tokenTitle: '工作階段權杖',
    tokenDesc: '貼上另一套 Jarvis 環境提供的工作階段權杖。',
    pasteSessionToken: '貼上工作階段權杖',
    incompleteSignInTest: '測試此連線前請先登入。',
    incompleteTokenTest: '測試此連線前請輸入工作階段權杖。',
    testConnection: '測試連線',
    testSucceeded: (baseUrl, version) => `已連線到 ${baseUrl}${version ? ` (${version})` : ''}。`,
    applyRemote: '連線',
    backToSetup: '返回',
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 Jarvis',
    finishingTitle: '正在收尾',
    failedDesc:
