...
export function TitlebarControls({ leftTools = [], tools = [], onOpenSettings }: TitlebarControlsProps) {
  ...
  // The consumer shell owns a single assistant surface. Layout editing, pane
  // flipping, terminals, and worker chrome remain available in the engine but
  // are intentionally absent from the ordinary Jarvis titlebar.
  const visiblePaneTools: TitlebarTool[] = []
