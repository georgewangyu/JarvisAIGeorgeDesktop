 ...
 *
 * A public install can end up with `origin=git@github.com:georgewangyu/JarvisAIGeorgeDesktop.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/georgewangyu/JarvisAIGeorgeDesktop.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/georgewangyu/jarvisaigeorgedesktop'
