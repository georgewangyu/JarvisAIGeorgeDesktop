...
def run_reported_turn(argv: list, *, env: MutableMapping[str, str], report_path: str, timeout: float,
                      exit_grace: float | None = REPORTED_TURN_EXIT_GRACE_SECONDS) -> subprocess.CompletedProcess:
    ...
    proc = subprocess.Popen(
        ...
        encoding="utf-8", errors="replace", env={**env, TURN_REPORT_FILE_ENV: report_path},
