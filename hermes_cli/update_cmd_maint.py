...
_REINSTALL_ONE_LINER = {
    True: "iex (irm https://raw.githubusercontent.com/georgewangyu/JarvisAIGeorgeDesktop/main/scripts/install.ps1)",
    False: "curl -fsSL https://raw.githubusercontent.com/georgewangyu/JarvisAIGeorgeDesktop/main/scripts/install.sh | bash",
}
